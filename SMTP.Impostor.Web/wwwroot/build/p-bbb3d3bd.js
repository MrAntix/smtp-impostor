        ...
        if ( Cstr.style) {
            ...
            if (!styles.has(scopeId)) {
                ...
                if ( cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                    style = await __sc_import_app('./p-ae551da3.js').then(m => m.scopeCss(style, scopeId, false));
                }
...
export { CSS as C, Host as H, NAMESPACE as N, promiseResolve as a, bootstrapLazy as b, Context as c, doc as d, createEvent as e, getContext as f, getElement as g, h, plt as p, registerInstance as r, win as w };
